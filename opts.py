...
def parse():
    ...
    parser.add_argument('--data', metavar='DIR', default='/Disk1/Charades_v1_rgb/',
                        help='path to dataset')
    # parser.add_argument('--dataset', metavar='DIR', default='fake',
    #                     help='name of dataset under datasets/')
    parser.add_argument('--train-file', default='./datasets/Charades_v1_train.csv', type=str)
    parser.add_argument('--val-file', default='./datasets/Charades_v1_test.csv', type=str)
